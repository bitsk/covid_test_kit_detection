...
typedef enum {
    ...
    AIPU_STATUS_ERROR_GRAPH_NOT_EXIST      = 0xB,
    ...
    AIPU_STATUS_ERROR_JOB_NOT_EXIST        = 0x10,
    AIPU_STATUS_ERROR_JOB_NOT_SCHED        = 0x11,
    AIPU_STATUS_ERROR_JOB_SCHED            = 0x12,
    AIPU_STATUS_ERROR_JOB_NOT_END          = 0x13,
    AIPU_STATUS_ERROR_JOB_EXCEPTION        = 0x14,
    AIPU_STATUS_ERROR_JOB_TIMEOUT          = 0x15,
    AIPU_STATUS_ERROR_INVALID_OPTIONS      = 0x16,
    AIPU_STATUS_ERROR_INVALID_PATH         = 0x17,
    AIPU_STATUS_ERROR_OP_NOT_SUPPORTED     = 0x18,
    AIPU_STATUS_ERROR_INVALID_OP           = 0x19,
    AIPU_STATUS_ERROR_INVALID_SIZE         = 0x1A,
    AIPU_STATUS_ERROR_INVALID_HANDLE       = 0x1B,
    AIPU_STATUS_ERROR_BUSY_HANDLE          = 0x1C,
    AIPU_STATUS_ERROR_BUF_ALLOC_FAIL       = 0x1D,
    AIPU_STATUS_ERROR_BUF_FREE_FAIL        = 0x1E,
    AIPU_STATUS_ERROR_INVALID_CORE_ID      = 0x1F,
    AIPU_STATUS_ERROR_RESERVE_SRAM_FAIL    = 0x20,
    AIPU_STATUS_MAX = 0x21
} aipu_status_t;
 ...
 * @param[in]  size  Graph buffer size (in bytes)
 ...
 * @retval AIPU_STATUS_ERROR_INVALID_CTX
 *
 * @note This API should be called by debugger before any other debugger APIs.
 */
 ...
 * @note The core ID should be less than core count returned by AIPU_debugger_get_core_cnt.
 */
 ...
 * @retval AIPU_STATUS_ERROR_BUF_ALLOC_FAIL
 *
 * @note This API shall be used before calling AIPU_debugger_bind_job.
